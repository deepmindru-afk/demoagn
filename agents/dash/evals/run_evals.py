...
Usage:
    python -m agents.dash.evals.run_evals
    python -m agents.dash.evals.run_evals --category basic
    python -m agents.dash.evals.run_evals --verbose
    python -m agents.dash.evals.run_evals --llm-grader
    python -m agents.dash.evals.run_evals --compare-results
"""
...
from agents.dash.evals.test_cases import CATEGORIES, TEST_CASES, TestCase
...
def evaluate_response(
    ...
    if llm_grader:
        try:
            from agents.dash.evals.grader import grade_response
