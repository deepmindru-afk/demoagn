...
Usage:
    python -m agents.dash.scripts.load_knowledge             # Upsert (update existing)
    python -m agents.dash.scripts.load_knowledge --recreate  # Drop and reload all
"""

import argparse

from agents.dash.paths import KNOWLEDGE_DIR
...
if __name__ == "__main__":
    ...
    from agents.dash.agent import dash_knowledge
