"""
Run evaluations against the Knowledge agent.

Usage:
    python -m agents.knowledge.evals.run_evals
    python -m agents.knowledge.evals.run_evals --category concepts
    python -m agents.knowledge.evals.run_evals --verbose
    python -m agents.knowledge.evals.run_evals --llm-grader
"""
...
def run_evals(
    ...
    with Progress(
        ...
        for test_case in tests:
            ...
            try:
                run_result = knowledge_agent.run(test_case.question)
...
def evaluate_response(
    ...
    if llm_grader:
        try:
            from agents.knowledge.evals.grader import grade_response
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Knowledge agent evaluations")
