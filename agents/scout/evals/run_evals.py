...
Usage:
    python -m agents.scout.evals.run_evals
    python -m agents.scout.evals.run_evals --category policy
    python -m agents.scout.evals.run_evals --verbose
    python -m agents.scout.evals.run_evals --llm-grader
    python -m agents.scout.evals.run_evals --check-sources
"""
...
def evaluate_response(
    ...
    if check_sources and test_case.golden_path:
        try:
            from agents.scout.evals.grader import check_source_citation
    ...
    if llm_grader:
        try:
            from agents.scout.evals.grader import grade_response
